...
class StableVideoDiffusionPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        if output_type == 'frames':
            ...
            #frames = self.decode_latents(latents[:,0:1,:,:,:], num_frames, decode_chunk_size)
...
#######################################################################################################
    ...
    def inv(
        ...
        ######## modify inverse here
        if denoise_beg is not None:
             timesteps = reversed(timesteps[denoise_end:denoise_beg])
        ...
        if True:
            for i, t in enumerate(timesteps):
                ...
                latents = self.scheduler.backstep(noise_pred, t, latents).prev_sample
