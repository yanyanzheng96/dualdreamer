...
class GUI:
    def __init__(self, opt):
        ...
        export_to_gif(front_list, os.path.join( self.opt.visual_dir , f'edit3dwithpth_front.gif'), )
        export_to_gif(full_list, os.path.join( self.opt.visual_dir , f'edit3dwithpth_full.gif'), )
        ...
        export_to_gif(front_list, os.path.join( self.opt.visual_dir , f'edit4dwithpth_front.gif'), )
        export_to_gif(full_list, os.path.join( self.opt.visual_dir , f'edit4dwithpth_full.gif'), )
