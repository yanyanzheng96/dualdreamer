...
if is_transformers_available():
    ...
    from diffusers.models.lora import PatchedLoraProjection, text_encoder_attn_modules, text_encoder_mlp_modules
...
LORA_WEIGHT_NAME = "pytorch_lora4unet_weights.bin"
LORA_WEIGHT_NAME_SAFE = "pytorch_lora4unet_weights.safetensors"
...
class LoraLoaderMixin:
    r"""
    Load LoRA layers into [`UNetSpatioTemporalConditionModel`]
    """
    ...
    @classmethod
    def _modify_spatiotemporal_unet(
        cls,
        unet,
        lora_scale=1,
        network_alphas=None,
