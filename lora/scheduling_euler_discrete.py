...
class EulerDiscreteScheduler(SchedulerMixin, ConfigMixin):
    ...
    def add_noise_info(
        ...
        noisy_samples = original_samples + noise * sigma # torch.Size([1, 10, 4, 64, 64])

        print('here, calling customized function add_noise_info')
        #print('noisy', noisy_samples[0,0,0,0,0:10])
