...
class EulerDiscreteScheduler(SchedulerMixin, ConfigMixin):
    ...
    def backstep(
        ...
        dt = self.sigmas[self.step_index-1 + 1] - sigma_hat

        #prev_sample = sample + derivative * dt
        back_sample = sample - derivative * dt

        # Cast sample back to model compatible dtype
        back_sample = back_sample.to(model_output.dtype)
        ...
        return EulerDiscreteSchedulerOutput(prev_sample=back_sample, pred_original_sample=pred_original_sample)
