...
class GUI:
    def __init__(self, opt):
        ...
        # load backgrounds 
        bgpngs = './test_bg_moving/sea_generate'
    ...
    def train_step(self, i):
        ...
        for _ in range(self.train_steps): # 1
            ...
            if i <= sec_1:
                ################################ apply only first frame image inversion 
            ...
            if i > sec_1:
                ...
                for _ in range(num_reverse):
                    ...
                    print(f'inversion for training step {i} view {_} hor {hors[_]}')
                    ...
                    export_to_gif(pngs, f'./logs_4D/exp_{self.opt.timestamp}_4D/inversion_{i}_hor_{hors[_]}.gif')
            ...
            for iii in range(train_iters):
                ...
                loss.backward()
                print(f'exp {self.opt.timestamp}, step {i}, iter {iii}', loss.item())
